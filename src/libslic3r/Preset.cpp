...
static std::vector<std::string> s_Preset_print_options {
    ...
    "seam_position", "seam_belt_honor_painting", "staggered_inner_seams", "wall_sequence", "is_infill_first", "sparse_infill_density","fill_multiline", "sparse_infill_pattern", "lateral_lattice_angle_1", "lateral_lattice_angle_2", "infill_overhang_angle", "top_surface_pattern", "bottom_surface_pattern",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "printer_is_belt", "belt_angle", "belt_axis", "belt_inclined_gcode", "belt_wall_enabled",
